...
A Python Flask web application that analyzes the sentiment (joy likelihood) of human faces in uploaded images. Built for deployment on Google App Engine, this app leverages Google Cloud's AI and data [...]
